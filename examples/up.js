...
var upCache = {};
var cachePath = process.cwd() + '/up.cache';
...
module.exports = function(options) {
    ...
    function upload(file) {
        ...
        if (!cacheByPath[file.path]) {
            ...
            if (!upCache[hash]) {
                ...
                cacheByPath[file.path] = upCache[hash] = options.uploader(file).then(function(url) {
                ...
                cached = true;
                cacheByPath[file.path] = upCache[hash];
            }
        } else {
            cached = true;
        }
    ...
    return through.obj(function(file, encoding, callback) {
        ...
        parse(file, getFileType(file)).then(function(content) {
            file.contents = new Buffer(content);
            me.push(file);
